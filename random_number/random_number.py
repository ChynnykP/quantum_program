...
from Qrng import SampleQuantumRandomNumberGenerator # We import the
                                                    # quantum operation from the
                                                    # namespace defined in the file quantum-random-number.qs
...
while output > max:
    ...
    for i in range(0, max.bit_length()):
        # We need to call the quantum operation
        # as many times as bits are needed to define the
        ...
        # Here we call the quantum operation and store the random bit in the list
